...
CREATE TABLE Productos (
  ...
  ID_Categoria INT, --mención a una llave foranea 
  Precio INT);
...
VALUES ('Comida Rápida'), ('Postres'), ('Bebidas'), ('Ensaladas'), ('Desayunos'),
...
VALUES ('John Doe', 'Gerente', 'Administración', 1, 'Vendedor'),
('Jane Smith', 'Subgerente', 'Ventas', 1, 'Vendedor'),('Bill Jones', 'Cajero', 'Ventas', 1, 'Vendedor'),
('Alice Johnson', 'Cocinero', 'Cocina', 1, 'Vendedor'), ('Tom Brown', 'Barista', 'Cafetería', 1, 'Vendedor'),
